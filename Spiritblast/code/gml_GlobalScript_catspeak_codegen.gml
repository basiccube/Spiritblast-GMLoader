...
function CatspeakGMLCompiler(ir, interface=undefined) constructor {
    ...
    /// @ignore
    self.filepath = struct_get(ir, "filepath"); // like this for compatibility with old versions
    /// @ignore
    self.sharedData = {
        globals : { },
        self_ : undefined,
...
function __catspeak_expr_call_method__() {
    ...
    if (is_array(collection_)) {
        ...
        callee_ = struct_get(collection_, key_);
    } else {
...
function __catspeak_expr_index_get__() {
    ...
    if (is_array(collection_)) {
        ...
        return struct_get(collection_, key_);
    } else {
        __catspeak_error_v3_got(dbgError, collection_);
    }
}
...
function __catspeak_expr_index_set__() {
    ...
    if (is_array(collection_)) {
        ...
        var specialSet = struct_get(global.__catspeakGmlSpecialVars, key_);
        if (specialSet != undefined) {
            specialSet(collection_, value_);
            return;
        }
        struct_set(collection_, key_, value_);
    } else {
        __catspeak_error_v3_got(dbgError, collection_);
    }
}
...
function __catspeak_expr_index_set_mult__() {
    ...
    if (is_array(collection_)) {
        ...
        var specialSet = struct_get(global.__catspeakGmlSpecialVars, key_);
        if (specialSet != undefined) {
            specialSet(collection_, struct_get(collection_, key_) * value_);
            return;
        }

        var kv = struct_get(collection_, key_);
        struct_set(collection_, key_, kv * value_);
    } else {
        __catspeak_error_v3_got(dbgError, collection_);
    }
}
...
function __catspeak_expr_global_get__() {
    return struct_get(shared.globals, name);
}

/// @ignore
/// @return {Any}
function __catspeak_expr_global_set__() {
    struct_set(shared.globals, name, value());
}

/// @ignore
/// @return {Any}
function __catspeak_expr_global_set_mult__() {
    var val = struct_get(shared.globals, name);
    struct_set(shared.globals, name, val * value());
}
...
function __catspeak_init_codegen() {
    ...
    struct_set(db, "enabled", function (s, v) { s.enabled = v });
    struct_set(db, "left", function (s, v) { s.left = v });
    struct_set(db, "right", function (s, v) { s.right = v });
    struct_set(db, "top", function (s, v) { s.top = v });
    struct_set(db, "bottom", function (s, v) { s.bottom = v });
    struct_set(db, "tilemode", function (s, v) { s.tilemode = v });
    struct_set(db, "frame", function (s, v) { s.frame = v });
    struct_set(db, "length", function (s, v) { s.length = v });
    struct_set(db, "stretch", function (s, v) { s.stretch = v });
    struct_set(db, "channels", function (s, v) { s.channels = v });
    struct_set(db, "channel", function (s, v) { s.channel = v });
    struct_set(db, "sequence", function (s, v) { s.sequence = v });
    struct_set(db, "headPosition", function (s, v) { s.headPosition = v });
    struct_set(db, "headDirection", function (s, v) { s.headDirection = v });
    struct_set(db, "speedScale", function (s, v) { s.speedScale = v });
    struct_set(db, "volume", function (s, v) { s.volume = v });
    struct_set(db, "paused", function (s, v) { s.paused = v });
    struct_set(db, "finished", function (s, v) { s.finished = v });
    struct_set(db, "activeTracks", function (s, v) { s.activeTracks = v });
    struct_set(db, "elementID", function (s, v) { s.elementID = v });
    struct_set(db, "name", function (s, v) { s.name = v });
    struct_set(db, "loopmode", function (s, v) { s.loopmode = v });
    struct_set(db, "playbackSpeed", function (s, v) { s.playbackSpeed = v });
    struct_set(db, "playbackSpeedType", function (s, v) { s.playbackSpeedType = v });
    struct_set(db, "xorigin", function (s, v) { s.xorigin = v });
    struct_set(db, "yorigin", function (s, v) { s.yorigin = v });
    struct_set(db, "tracks", function (s, v) { s.tracks = v });
    struct_set(db, "messageEventKeyframes", function (s, v) { s.messageEventKeyframes = v });
    struct_set(db, "momentKeyframes", function (s, v) { s.momentKeyframes = v });
    struct_set(db, "event_create", function (s, v) { s.event_create = v });
    struct_set(db, "event_destroy", function (s, v) { s.event_destroy = v });
    struct_set(db, "event_clean_up", function (s, v) { s.event_clean_up = v });
    struct_set(db, "event_step", function (s, v) { s.event_step = v });
    struct_set(db, "event_step_begin", function (s, v) { s.event_step_begin = v });
    struct_set(db, "event_step_end", function (s, v) { s.event_step_end = v });
    struct_set(db, "event_async_system", function (s, v) { s.event_async_system = v });
    struct_set(db, "event_broadcast_message", function (s, v) { s.event_broadcast_message = v });
    struct_set(db, "type", function (s, v) { s.type = v });
    struct_set(db, "subType", function (s, v) { s.subType = v });
    struct_set(db, "traits", function (s, v) { s.traits = v });
    struct_set(db, "interpolation", function (s, v) { s.interpolation = v });
    struct_set(db, "visible", function (s, v) { s.visible = v });
    struct_set(db, "linked", function (s, v) { s.linked = v });
    struct_set(db, "linkedTrack", function (s, v) { s.linkedTrack = v });
    struct_set(db, "keyframes", function (s, v) { s.keyframes = v });
    struct_set(db, "disabled", function (s, v) { s.disabled = v });
    struct_set(db, "spriteIndex", function (s, v) { s.spriteIndex = v });
    struct_set(db, "soundIndex", function (s, v) { s.soundIndex = v });
    struct_set(db, "emitterIndex", function (s, v) { s.emitterIndex = v });
    struct_set(db, "playbackMode", function (s, v) { s.playbackMode = v });
    struct_set(db, "imageIndex", function (s, v) { s.imageIndex = v });
    struct_set(db, "value", function (s, v) { s.value = v });
    struct_set(db, "colour", function (s, v) { s.colour = v });
    struct_set(db, "color", function (s, v) { s.color = v });
    struct_set(db, "curve", function (s, v) { s.curve = v });
    struct_set(db, "objectIndex", function (s, v) { s.objectIndex = v });
    struct_set(db, "text", function (s, v) { s.text = v });
    struct_set(db, "events", function (s, v) { s.events = v });
    struct_set(db, "event", function (s, v) { s.event = v });
    struct_set(db, "graphType", function (s, v) { s.graphType = v });
    struct_set(db, "iterations", function (s, v) { s.iterations = v });
    struct_set(db, "points", function (s, v) { s.points = v });
    struct_set(db, "posx", function (s, v) { s.posx = v });
    struct_set(db, "matrix", function (s, v) { s.matrix = v });
    struct_set(db, "posy", function (s, v) { s.posy = v });
    struct_set(db, "rotation", function (s, v) { s.rotation = v });
    struct_set(db, "scalex", function (s, v) { s.scalex = v });
    struct_set(db, "scaley", function (s, v) { s.scaley = v });
    struct_set(db, "gain", function (s, v) { s.gain = v });
    struct_set(db, "pitch", function (s, v) { s.pitch = v });
    struct_set(db, "width", function (s, v) { s.width = v });
    struct_set(db, "height", function (s, v) { s.height = v });
    struct_set(db, "imagespeed", function (s, v) { s.imagespeed = v });
    struct_set(db, "colormultiply", function (s, v) { s.colormultiply = v });
    struct_set(db, "colourmultiply", function (s, v) { s.colourmultiply = v });
    struct_set(db, "coloradd", function (s, v) { s.coloradd = v });
    struct_set(db, "colouradd", function (s, v) { s.colouradd = v });
    struct_set(db, "instanceID", function (s, v) { s.instanceID = v });
    struct_set(db, "track", function (s, v) { s.track = v });
    struct_set(db, "parent", function (s, v) { s.parent = v });
    struct_set(db, "objects_touched", function (s, v) { s.objects_touched = v });
    struct_set(db, "objects_collected", function (s, v) { s.objects_collected = v });
    struct_set(db, "traversal_time", function (s, v) { s.traversal_time = v });
    struct_set(db, "collection_time", function (s, v) { s.collection_time = v });
    struct_set(db, "gc_frame", function (s, v) { s.gc_frame = v });
    struct_set(db, "generation_collected", function (s, v) { s.generation_collected = v });
    struct_set(db, "num_generations", function (s, v) { s.num_generations = v });
    struct_set(db, "num_objects_in_generation", function (s, v) { s.num_objects_in_generation = v });
    struct_set(db, "ref", function (s, v) { s.ref = v });
}