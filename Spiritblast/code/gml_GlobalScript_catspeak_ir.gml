...
function CatspeakIRBuilder(filepath=undefined) constructor {
    ...
    static createGet = function (name, location=undefined) {
        ...
        for (
            ...
            localIdx = ds_map_find_value(scope, name);
        }
    ...
    static allocLocal = function (name, location=undefined) {
        ...
        ds_map_set(scope, name, localIdx);
        return __createTerm(CatspeakTerm.LOCAL, location, {
            idx : localIdx
        });
    };
    ...
    static allocLocalOrReuse = function (name, location=undefined) {
        ...
        if (ds_map_exists(scope, name)) {
            // __createTerm() will do argument validation
            return __createTerm(CatspeakTerm.LOCAL, location, {
                idx : ds_map_find_value(scope, name),
            });
        } else {
    ...
    static popBlock = function (location=undefined) {
        ...
        if (finalCount == 0) {
            ...
            var blockLocation = location ?? ds_list_find_value(terms, 0).dbg;
