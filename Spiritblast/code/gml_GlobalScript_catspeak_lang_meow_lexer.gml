...
function CatspeakLexer(buff, offset = undefined, size = undefined)
    ...
    static __completeIdent = function () {
        if (charCurr == ord("`")) {
            ...
            value = getLexeme();
            hasValue = true;
            var keyword = struct_get(__keywords, value);
            if (keyword != undefined) {
                return keyword;
            }
            var literal = struct_get(__literals, value);
    ...
    if (__keywords == undefined) {
        __keywords = { };
        struct_set(__keywords, "self", CatspeakToken.SELF);
        struct_set(__keywords, "other", CatspeakToken.OTHER);
        struct_set(__keywords, "params", CatspeakToken.PARAMS);
        struct_set(__keywords, "and", CatspeakToken.AND);
        struct_set(__keywords, "or", CatspeakToken.OR);
        struct_set(__keywords, "xor", CatspeakToken.XOR);
        struct_set(__keywords, "do", CatspeakToken.DO);
        struct_set(__keywords, "if", CatspeakToken.IF);
        struct_set(__keywords, "else", CatspeakToken.ELSE);
        struct_set(__keywords, "while", CatspeakToken.WHILE);
        struct_set(__keywords, "for", CatspeakToken.FOR);
        struct_set(__keywords, "loop", CatspeakToken.LOOP);
        struct_set(__keywords, "with", CatspeakToken.WITH);
        struct_set(__keywords, "match", CatspeakToken.MATCH);
        struct_set(__keywords, "fun", CatspeakToken.FUN);
        struct_set(__keywords, "new", CatspeakToken.NEW);
        struct_set(__keywords, "impl", CatspeakToken.IMPL);
        struct_set(__keywords, "catch", CatspeakToken.CATCH);
        struct_set(__keywords, "return", CatspeakToken.RETURN);
        struct_set(__keywords, "continue", CatspeakToken.CONTINUE);
        struct_set(__keywords, "break", CatspeakToken.BREAK);
        struct_set(__keywords, "throw", CatspeakToken.THROW);
        struct_set(__keywords, "let", CatspeakToken.LET);
    }
    ...
    if (__literals == undefined) {
        __literals = { };
        struct_set(__literals, "true", true);
        struct_set(__literals, "false", false);
        struct_set(__literals, "NaN", NaN);
        struct_set(__literals, "infinity", infinity);
    }
